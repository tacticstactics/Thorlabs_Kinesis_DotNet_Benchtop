...
namespace BSC_BenchtopStepperMotor
{
    ...
    {
        const string SerialNumber = "40846688";
        ...
        private void buttonChannelOneConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // unit parameters.
                _stepperMotorChannelOne.GetMotorConfiguration(SerialNumber,0);
        ...
        private void buttonChannelOneMoveToTen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // We ask the device to throw an exception if the operation takes
                // longer than 6000ms (6s).
                 _stepperMotorChannelOne.MoveTo(5m, 10000);
        ...
        private void buttonChannelOneMoveRelativeForward_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _stepperMotorChannelOne.SetMoveRelativeDistance(1);

                _stepperMotorChannelOne.MoveRelative(10000);
        ...
        private void buttonChannelOneMoveRelativeBackward_Click(object sender, EventArgs e)
        {
        ...
        private void buttonChannelTwoConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Initialize the DeviceUnitConverter object required for real world
                // unit parameters.
                _stepperMotorChannelTwo.GetMotorConfiguration(SerialNumber, 0);
